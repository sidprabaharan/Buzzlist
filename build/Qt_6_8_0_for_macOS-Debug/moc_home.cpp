...
constexpr auto qt_meta_stringdata_CLASSHomeENDCLASS = QtMocHelpers::stringData(
    "Home",
    "switchTobarWorkerScan",
    "",
    "switchTobarWorkerQueue"
);
...
Q_CONSTINIT const QMetaObject Home::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSHomeENDCLASS_t,
        ...
        // method 'switchTobarWorkerScan'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'switchTobarWorkerQueue'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void Home::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->switchTobarWorkerScan(); break;
        case 1: _t->switchTobarWorkerQueue(); break;
        default: ;
        }
        ...
        {
            using _t = void (Home::*)();
            if (_t _q_method = &Home::switchTobarWorkerScan; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Home::*)();
            if (_t _q_method = &Home::switchTobarWorkerQueue; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Home::switchTobarWorkerScan()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Home::switchTobarWorkerQueue()
{
