/****************************************************************************
** Meta object code from reading C++ file 'waitingpage.h'
**
...
#error "The header file 'waitingpage.h' doesn't include <QObject>."
...
void WaitingPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<WaitingPage *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->updateCountdown(); break;
        case 1: _t->updateTimeLabel(); break;
        default: ;
        }
    }
    (void)_a;
